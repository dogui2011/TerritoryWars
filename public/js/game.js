...
app.innerHTML = [
  '<header class="topbar"><a class="brand" href="/"><span class="brand-mark">✦</span><span>FRONTSWARS</span></a><div id="connection-status" class="connection"><span class="status-dot"></span> CONNECTING</div></header>',
  '<main>',
