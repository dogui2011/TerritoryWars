...
app.get('/', (_req, res) => res.send(lt + 'html' + gt + lt + 'head' + gt + lt + 'meta charset="UTF-8"' + gt + lt + 'meta name="viewport" content="width=device-width,initial-scale=1"' + gt + lt + 'title' + gt + 'FrontsWars.io' + lt + '/title' + gt + lt + 'link rel="stylesheet" href="/css/styles.css"' + gt + lt + '/head' + gt + lt + 'body' + gt + lt + 'div id="app"' + gt + lt + '/div' + gt + lt + 'script src="/socket.io/socket.io.js"' + gt + lt + '/script' + gt + lt + 'script src="/js/game.js"' + gt + lt + '/script' + gt + lt + '/body' + gt + lt + '/html' + gt));
...
httpServer.listen(PORT, '0.0.0.0', () => console.log('FrontsWars.io listening on port ' + PORT));
